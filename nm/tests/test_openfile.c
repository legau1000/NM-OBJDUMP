...
Test(open_file, good_standard_file)
{
    ...
    printf("Units Tests **NM** open_file: Good standard file ====> \tOK\n");
}
...
Test(open_file, file_dont_exist)
{
    ...
    printf("Units Tests **NM** open_file: File don't exist ====> \tOK\n");
}
...
Test(open_file, dynamique_library)
{
    ...
    cr_assert(open_file(&list) == 0);
    printf("Units Tests **NM** open_file: Dynamique library ====> \tOK\n");
}